package HandsOn.Desafio5.br.com.UsbSystems.View;


import HandsOn.Desafio5.br.com.UsbSystems.Model.Endereco;
import HandsOn.Desafio5.br.com.UsbSystems.Model.Gerente;
...
public class ViewGerente {
    ...
    private static Gerente cadastrarGerente() {
        ...
        gerente.setNome(sc.next() + sc.nextLine());

        System.out.println("Informe o logradouro: ");
        System.out.println("Informe o numero da casa: ");
        System.out.println("Informe a cidade do gerente: ");
        gerente.setEndereco(new Endereco(sc.nextLine(), sc.nextInt(), sc.next()));
